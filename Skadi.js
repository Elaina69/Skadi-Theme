...
function themeReload() {
   ...
   style.href = 'https://static.staticsave.com/skaditheme/skadilolnosbfont.css';
   style.type = 'text/css';
...
// CSS link //
   document
      ...
      .insertAdjacentHTML(
         'afterbegin',
         '<link rel="stylesheet" href="https://static.staticsave.com/skaditheme/skadilolnosbfont.css" />'
      );


// Video Background link (You can Disable it or delete the link to using static background) //
   document.querySelector('body').innerHTML += "<video src="+"'https://raw.githubusercontent.com/Roydevil/Skadi-Theme/main/BG.mp4' style='position: absolute;top: 0;width: 1280px;z-index: -1;pointer-events: none;' autoplay loop muted></video>"


// Background music link (Delete link to disable)
var source = "https://raw.githubusercontent.com/Roydevil/Skadi-Theme/main/UnderTides.mp3"
